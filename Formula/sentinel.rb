...
# Sentinel is a policy-as-code framework for managing and enforcing policies across infrastructure.
# It allows you to define, enforce, and monitor policies in a consistent and automated way.
# This formula installs the latest stable version of the Sentinel CLI tool.
