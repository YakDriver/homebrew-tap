...
# Boundary is a tool for managing secure access to applications and critical systems.
# It provides a secure way to access hosts and services without managing credentials or exposing your network.
# This formula installs the latest stable version of the Boundary CLI tool.
